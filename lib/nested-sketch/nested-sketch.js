...
import { forgivingMatchTest, objectToURLParams, convertRelativeToAbsoluteLinks, isWikipedia, isYouTube } from './utils/helpers.js';
...
Nutshell.promiseSectionContainer = (expandable)=>{
    ...
    return new Promise((resolve,reject)=>{
        ...
        promisePurifiedHTMLFromURL(url, Nutshell.htmlCache).then((purifiedHTML)=>{
